...
import 'package:beeblock_test_yellow/OneCoinTrade/CoinName/Trade/TopToggleButton.dart';
import 'package:beeblock_test_yellow/OneCoinTrade/CoinName/Trade/pricetextfield.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        PriceTextField('가격 KRW', initial),   /// 가격 입력
        SizedBox(
          height: 12.0,
        ),
